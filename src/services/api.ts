import { User, Product, Sale, SupervisorOperation, ProductList } from "@/types";
...
export const api = {
  ...
  async getProducts(): Promise<ProductList> {
    const response: ProductList = await fetch(
      `${API_URL}/products?searchCriteria[filter_groups][0][filters][0][field]=sku&searchCriteria[filter_groups][0][filters][0][value]=&searchCriteria[filter_groups][0][filters][0][condition_type]=neq`
